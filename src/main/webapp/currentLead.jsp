		...
		<div class="container-fluid">
  			...
  			try{
				...
				count = rs1.getInt("id");
  				...
  				PreparedStatement ps = connect.prepareStatement("select name, email, source, date, owner, priority from leads where  currentowner= ?");
				 ...
				 /* for (int a = 1; a <= count; a++) {  */
							...
							while (rs.next()) {
								...
								out.print("<td style = 'color: rgba(252, 0, 130, 1)'>" + owner + "</td>");
