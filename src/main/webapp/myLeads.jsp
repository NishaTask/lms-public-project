		...
		<div class="container-fluid">
  			...
  			try{
				...
				count = rs1.getInt("id");
  				...
  				PreparedStatement ps = connect.prepareStatement("select name, email, source, date, priority, currentowner from leads where owner = ?");
